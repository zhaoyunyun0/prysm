...
type BeaconChainConfig struct {
	...
	BuilderDelayTime                 time.Duration   // BuilderDelayTime is the time to wait for collecting builder proposals before proposing a block. This value is set by the validator flags.
